function [sta,lat,lon,elev] = importStationFile(filename, startRow, endRow)
% J. Pesicek importdata from HB station file with elevations
%
%IMPORTFILE Import numeric data from a text file as column vectors.
%   [STA,LAT,LON,ELEV] = IMPORTFILE(FILENAME) Reads data from text file
%   FILENAME for the default selection.
%
%   [STA,LAT,LON,ELEV] = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data
%   from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   [sta,lat,lon,elev] = importfile('AV_stations.txt',1, 209);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2015/11/19 01:18:01
