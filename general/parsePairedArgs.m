function [ properties ] = parsePairedArgs( arglist )
%PARSEPAIREDARGS Creates a structure of parameter names and values from
%input arguments
...
% This code is a near-copy of GISMO's waveform/parseargs.m function
