function index=structfind2(a,field,value)
...
%{
Modifications by Jay Wellik (jwellik at usgs.gov)
Fr 2016 Feb 5 - search functions for multiple values
Fr 2016 Feb 5 - produce an error if the field does not exist
%}
...
if(~isfield(a,field))
    ...
    error('That field does not exist :-(')
    ...
    for n = 1:length(value)
        ...
        idx = find(arrayfun(@(x)(cmp(x,field,value{n})),a,'uniformoutput',true));
        index = [index; idx];
