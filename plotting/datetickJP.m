...
if nin==2 && isnumeric(dateform), % Determine dateformat from string.
    switch dateform
...
if nin > 0 & ishandle(v{1}) &      ismember(get(v{1},'type'),{'axes' 'colorbar'}) %#ok ishandle return is not scalar
