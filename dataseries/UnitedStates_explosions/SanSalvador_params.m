...
volcano_list = table({'San Salvador'}, 13.734, -89.294, 6209, 'VariableNames', {'volcano_name', 'lat', 'lon', 'elev'});
...
% explosions_data.dir = '/Users/jaywellik/Documents/MATLAB/VDAP_mbin/dataseries/UnitedStates_explosions/data/';
explosion_list = table({'San Salvador'}, datetime(1917,6,1), datetime(1917,11,1), 3, ...
    'VariableNames', {'volcano', 'start', 'stop', 'vei'});
...
t_window = {[1 1] [1 30]}; % traditional ranges
